...
python fpfair/validate_on_lfw.py fpfair/lfw/lfw-align-160 default --lfw_pairs lfw_pairs_all_Black.txt --attribute Black --all true --gpu 1
python fpfair/validate_on_lfw.py fpfair/lfw/lfw-align-160 default --lfw_pairs lfw_pairs_all_White.txt --attribute White --all true --gpu 1
python fpfair/validate_on_lfw.py fpfair/lfw/lfw-align-160 default --lfw_pairs lfw_pairs_all_Indian.txt --attribute Indian --all true --gpu 1

python fpfair/validate_on_lfw.py fpfair/lfw/lfw-align-160 race_balance --lfw_pairs lfw_pairs_Male.txt --attribute Male --all false --gpu 1
python fpfair/validate_on_lfw.py fpfair/lfw/lfw-align-160 race_balance --lfw_pairs lfw_pairs_NOTMale.txt --attribute NOTMale --all false --gpu 1
python fpfair/validate_on_lfw.py fpfair/lfw/lfw-align-160 race_balance --lfw_pairs lfw_pairs_Asian.txt --attribute Asian --all false --gpu 1
python fpfair/validate_on_lfw.py fpfair/lfw/lfw-align-160 race_balance --lfw_pairs lfw_pairs_Black.txt --attribute Black --all false --gpu 1
python fpfair/validate_on_lfw.py fpfair/lfw/lfw-align-160 race_balance --lfw_pairs lfw_pairs_White.txt --attribute White --all false --gpu 1
python fpfair/validate_on_lfw.py fpfair/lfw/lfw-align-160 race_balance --lfw_pairs lfw_pairs_Indian.txt --attribute Indian --all false --gpu 1
